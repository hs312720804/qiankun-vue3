import { ref, reactive, computed, nextTick, h, Ref } from 'vue'
...
export default function useUserRepositories(menu: MenuDetailType, primaryKey: any, table: tableType, handleResource: Ref<handleResourceType>, fetchData:Function, handleTodo:Function, handleAction:Function, filter: apiType) {
  ...
  let renderMethodsUtils = computed(() => {
    return {
      ...handleResource.value.renderMethods, // 我们自己编写的页面上的方法，自定义的方法
      ...renderMethods
    }
  }) 
